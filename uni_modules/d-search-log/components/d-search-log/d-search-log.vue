	...
	<view class="dSLComVue">
		...
		<view class="dSLComVueTop">
			...
			<view class="margin-left">
				<button class="cu-btn bg-green shadow-blur round"  @click="onClickInput" >搜索</button>
				<!-- <view class="dSLComVueTopRightBtn":style="'border: 1rpx solid '+color_border+';color: '+color_text+';'">{{search_name?search_name:'搜索'}}</view> -->
			</view>
		</view>
...
<script>
	export default {
		...
		methods:{
			onClickInput(){
				console.log(111)
				this.$emit('onClickInput',this.search_input)
			},
